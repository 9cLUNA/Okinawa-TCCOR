...
# 6/21/2020 - They changed "CURRENT TCCOR INFORMATION" from "Current TCCOR Information"
...
# ensure saving image with 400 dpi
...
# look for text in case out of typhoon season

results = soup.body.findAll(text="NO ACTIVE TCCOR")
for i in results:
    print (i)